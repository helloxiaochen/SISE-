...
public class Science1 extends JFrame {
    ...
    public Science1() {
        ...
        final JTextField t8 = new JTextField(10);
        final JTextField t9 = new JTextField(10);
        final JTextField t10 = new JTextField(10);
        ...
        try {
            ...
            ct = DriverManager.getConnection("jdbc:mysql://localhost:3306/exam?useUnicode=true&serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&useSSL=false&allowPublicKeyRetrieval=true",
                    "root", "123456");
            ps = ct.prepareStatement("select * from science");
            rs = ps.executeQuery();
        ...
        // 创建 固定宽高 的不可见组件
//        Component rigidArea = Box.createRigidArea(new Dimension(700,50));
...
//        vBox.add(rigidArea);
        ...
        enterbtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(StringUtils.isEmpty(String.valueOf(physics1))){
                    JOptionPane.showMessageDialog(null,"物理成绩不能为空，必须为正数");
                    return;
                }
                ...
                if(e.getSource() == enterbtn){
                    ...
                    int physics = Integer.parseInt(t10.getText());
                    ...
                    DBSourse sourse = new DBSourse("com.mysql.cj.jdbc.Driver", "jdbc:mysql://localhost:3306/exam?useUnicode=true&serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&useSSL=false&allowPublicKeyRetrieval=true",
                            "root", "123456");
                    sql = "insert science(number,name,age,sex,school,score,chinese,math,english,physics,sum) value("+"?,?,?,?,?,?,?,?,?,?,?)";
                    ...
                    try {
                        ...
                        preparedStatement.setString(10,String.valueOf(physics));
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/exam?useUnicode=true&serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&useSSL=false&allowPublicKeyRetrieval=true",
                            "root","123456");
                    String sql = "delete from science where number=?";
