...
public class Liberal extends JFrame {
    ...
    public Liberal(){
        ...
        JLabel l11 = new JLabel("历史");
        JLabel l12 = new JLabel("地理");
        ...
        try {
            ...
            ct = DriverManager.getConnection("jdbc:mysql://localhost:3306/exam?useUnicode=true&serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&useSSL=false&allowPublicKeyRetrieval=true",
                    "root", "123456");
            ps = ct.prepareStatement("select * from liberal");
            rs = ps.executeQuery();
        ...
        enterbtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int history1 = t10.getColumns();
                int graphy1 = t11.getColumns();
                int sum1 = t12.getColumns();
                ...
                if(StringUtils.isEmpty(String.valueOf(history1))){
                    JOptionPane.showMessageDialog(null,"历史成绩不能为空,必须为正数");
                    return;
                }
                if(StringUtils.isEmpty(String.valueOf(graphy1))){
                    JOptionPane.showMessageDialog(null,"地理成绩不能为空,必须为正数");
                }
                ...
                if(e.getSource() == enterbtn){
                    ...
                    int history = Integer.parseInt(t10.getText());
                    int graphy = Integer.parseInt(t11.getText());
                    int sum = Integer.parseInt(t12.getText());
                    ...
                    DBSourse sourse = new DBSourse("com.mysql.cj.jdbc.Driver", "jdbc:mysql://localhost:3306/exam?useUnicode=true&serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&useSSL=false&allowPublicKeyRetrieval=true",
                            "root", "123456");
                    sql = "insert liberal(number,name,age,sex,school,score,chinese,math,english,history,graphy,sum) value("+"?,?,?,?,?,?,?,?,?,?,?,?)";
                    ...
                    try {
                        ...
                        preparedStatement.setString(10,String.valueOf(history));
                        preparedStatement.setString(11,String.valueOf(graphy));
                        preparedStatement.setString(12,String.valueOf(sum));
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/exam?useUnicode=true&serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&useSSL=false&allowPublicKeyRetrieval=true",
                            "root","123456");
                    String sql = "delete from liberal where number=?";
