...
public class ArtCheck extends JFrame {
    Connection con;
                ...
                if(stateChange==ItemEvent.SELECTED){
                    if(item == "广州"){
                        ...
                        try{
                            ...
                            String sql = "select * from art where score='广州'";
                            ResultSet rs = statement.executeQuery(sql);
                            a.append("考号\t姓名\t年龄\t性别\t中学名称\t语文\t数学\t英语\t艺术\t总分\n");
                            int number,age,chinese,math,english,art,sum;
                            ...
                            while (rs.next()){
                                ...
                                art = rs.getInt("art");
                                sum = rs.getInt("sum");
                                a.append(number+"\t"+name+"\t"+age+"\t"+sex+"\t"+school+"\t"+chinese+"\t"+math+"\t"+english+"\t"+art+"\t"+sum+"\n");
                            }
                        ...
                        try{
                            ...
                            //创建statement类对象，用来执行SQL语句
                            Statement statement = con.createStatement();
                            String sql = "select * from art where score='深圳'";
                            ResultSet rs = statement.executeQuery(sql);
                            a.append("考号\t姓名\t年龄\t性别\t中学名称\t语文\t数学\t英语\t艺术\t总分\n");
                            int number,age,chinese,math,english,art,sum;
                            String name,sex,school,score;
                        ...
                        try{
                            ...
                            //创建statement类对象，用来执行SQL语句
                            Statement statement = con.createStatement();
                            String sql = "select * from art where score='汕头'";
                            ResultSet rs = statement.executeQuery(sql);
                            a.append("考号\t姓名\t年龄\t性别\t中学名称\t语文\t数学\t英语\t艺术\t总分\n");
                            int number,age,chinese,math,english,art,sum;
                            String name,sex,school,score;
