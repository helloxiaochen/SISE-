...
public class ScienceCheck extends JFrame {
    Connection con;
                ...
                if(stateChange==ItemEvent.SELECTED){
                    if(item == "广州"){
                        ...
                        try{
                            ...
                            String sql = "select * from science where score='广州'";
                            ResultSet rs = statement.executeQuery(sql);
                            a.append("考号\t姓名\t年龄\t性别\t中学名称\t语文\t数学\t英语\t物理\t总分\n");
                            int number,age,chinese,math,english,physics,sum;
                            ...
                            while (rs.next()){
                                ...
                                sum = rs.getInt("sum");
                                a.append(number+"\t"+name+"\t"+age+"\t"+sex+"\t"+school+"\t"+chinese+"\t"+math+"\t"+english+"\t"+physics+"\t"+sum+"\n");
                            }
                        ...
                        try{
                            ...
                            //创建statement类对象，用来执行SQL语句
                            Statement statement = con.createStatement();
                            String sql = "select * from science where score='深圳'";
                            ResultSet rs = statement.executeQuery(sql);
                            a.append("考号\t姓名\t年龄\t性别\t中学名称\t语文\t数学\t英语\t物理\t总分\n");
                            int number,age,chinese,math,english,physics,sum;
                            String name,sex,school,score;
                        ...
                        try{
                            ...
                            //创建statement类对象，用来执行SQL语句
                            Statement statement = con.createStatement();
                            String sql = "select * from science where score='汕头'";
                            ResultSet rs = statement.executeQuery(sql);
                            a.append("考号\t姓名\t年龄\t性别\t中学名称\t语文\t数学\t英语\t物理\t总分\n");
                            int number,age,chinese,math,english,physics,sum;
                            String name,sex,school,score;
